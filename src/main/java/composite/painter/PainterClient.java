...
public class PainterClient {
    public static void main(String[] args) {
        ...
        Painter painter1 = new Painter(10);
        Painter painter2 = new Painter(10);
        Painter painter3 = new Painter(10);
        Painter painter4 = new Painter(10);
        ...
        LandLord landLord1 = new LandLord(10, paintingCompany);
